            ...
            <form class="row g-5" action="../Controllers/ModifProfilController.php" method="POST" enctype="multipart/form-data">
                ...
                <!-- Champ Nom-->
                 <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control form-control-sm" name="lastname" id="lastname" value="<?=$profil->lastname?>">
                </div>
                <!-- Champ prénom-->
                <div class="col-md-6 mb-3">
                    <label for="firstname" class="form-label">Prénom</label>
                    <input type="text" class="form-control form-control-sm" name="firstname" id="firstname" value="<?=$profil->firstname?>">
                </div>
                <!-- Champ pseudo-->
                <div class="col-md-6 mb-3">
                    <label for="alias" class="form-label">Pseudo</label>
                    <input type="text" class="form-control form-control-sm" name="alias" id="alias" value="<?=$profil->alias?>">
                </div>
                <!-- Champ mot de passe-->
                <div class="col-md-6 mb-3">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input class="form-control form-control-sm" name="date_start" id="date_start"
                        value="<?=$profil->date_start?>" type="date" />
                </div>
                <div class="col-md-3 mb-3">
                    <label for="date_end" class="control-label">Fin</label>
                    <input class="form-control form-control-sm" name="date_end" id="date_end" value="<?=$profil->date_end?>"
                        type="date" />
                </div>               
                <!-- Champ photo-->
                <div class="col-md-6 mb-3">
                ...
                <div class="mb-3 mb-3">
                    ...
                    <textarea class="form-control" value="<?=$profil->comment?>" name="comment" id="comment"
