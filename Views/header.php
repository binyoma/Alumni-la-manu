...
<div class="bg-light p-2">
        <!--Titre-->
        <h1 class="card-title titre p-4 text-center">ALUMNI<i class="bi bi-plus-lg text-danger"></i><small class="fw-lighter">La Manu</small></h1>
</div>
        ...
        <div class="container-fluid px-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active text-light fw-light py-0" aria-current="page" href="/Alumini-la-manu/Views/Profils-List.php">Profils des alumni</a>
                    </li>    
                    <li class="nav-item">
